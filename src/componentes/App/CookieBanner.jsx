...
const CookieBanner = () => {
  ...
  return (
    ...
    >
      <div className="max-w-[40vh] left-5 right-5 bg-white text-gray-700 p-4 rounded-lg shadow-lg flex flex-col sm:flex-row items-center justify-between gap-4 sm:max-w-[100vh] text-prim border border-bord border-opacity-50">
