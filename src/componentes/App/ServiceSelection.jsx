...
const ServiceSelection = ({ onProceed, onDaysChange, onServiceChange, setServiceValue, setTimeTotal }) => {
  ...
  const HandleSetTimeTotal = (value) => {
    setTimeTotal(value)
  }
              ...
              {loading ? (
                ...
                filteredServices.map((service, index) => (
                  <ServiceCard
                    ...
                    HandleSetTimeTotal={HandleSetTimeTotal}
                  />
                ))
              ) : (
