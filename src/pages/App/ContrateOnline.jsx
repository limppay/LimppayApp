    ...
    return (
        <>
            ...
            <main className="relative p-4 flex justify-center md:justify-around lg:justify-around gap-5 ">
                ...
                <div className={`sm:hidden fixed bottom-0 left-0 w-full transition-all duration-300 ease-in-out ${isExpanded ? 'h-[60vh]' : 'h-[8vh]'} bg-white border-2 border-desSec  rounded-t-3xl p-2  text-prim shadow-2xl  `}>
                    <div
                    ...
                    <div className={`overflow-y-auto p-4 ${isExpanded ? 'block' : 'hidden'}`}>
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-col gap-2">
                                <p className="text-lg font-semibold">Serviço selecionado:</p>
                                <p className="text-base">{selectedService || 'Nenhum serviço selecionado.'}</p>
                            </div>
