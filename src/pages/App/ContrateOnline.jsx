...
export default function ContrateOnline() {
    ...
    return (
        <>
            ...
            <main className="relative p-4 flex items-baseline">
                <div>
                ...
                {/* Cartão azul - Visível somente em telas grandes (desktop) */}
                    <div className="hidden lg:block pt-42">
                    <div className="bg-desSec text-white shadow-md rounded-lg p-12 flex flex-col items-center">
                        <h3 className="text-xl font-bold mb-28">Olá, agende um serviço conosco é fácil e rápido!</h3>
                        <img
